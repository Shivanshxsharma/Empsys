...
const Failedtask = ({empdata}) => {
  return (
    <div className='transition-all duration-300 hover:scale-105 ease-in-out shrink-0 w-120 h-[95%] rounded-3xl bg-red-400 '>
             <div className='mt-3 ml-3 bg-black w-20 h-10 rounded-xl text-white flex justify-center items-center'>Failed</div>
